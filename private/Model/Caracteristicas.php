...
class Caracteristicas extends Connection
{
    ...
    public $fields = ["gce_id_estado","gce_valor_estado","gce_id", "gce_nombre_equipo", "gce_board", "gce_case", "gce_procesador", "gce_grafica", "gce_ram", "gce_disco_duro", "gce_teclado", "gce_mouse", "gce_pantalla", "gce_estado", "gce_caracteristicas"];
    ...
    public function updateState(){
        ...
        $sql->bindParam(1, $this->gce_valor_estado, PDO::PARAM_STR, 255);
